...
Deanery::Deanery(std::string filename){
...
void Deanery::addMarksToAll(int mark){
...
void Deanery::saveStaff(std::string filename_group, std::string filename_students){
